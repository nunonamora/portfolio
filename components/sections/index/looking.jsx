	...
	return (
		<Section classProp={`${looking.section} borderBottom`}>
			<Container classProp={`${section.title} ${looking.container}`} spacing={['verticalXXXLrg']}>
				...
				<h2 className={looking.jsonSub}><span className={looking.highlight}>Full Stack Engineer</span>,</h2>
				<h2 className={looking.jsonSub}><span className={looking.highlight2}>Artificial Intelligence</span></h2>
